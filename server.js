...
const trades={schilder:'Schilder',stukadoor:'Stukadoor',lekkage:'Loodgieter',elektra:'Elektricien',verwarming:'Installateur',sanitair:'Loodgieter',dak:'Dakdekker',muren:'Stukadoor',vloer:'Vloerspecialist',deuren:'Timmerman',schimmel:'Vochtbestrijder',tuin:'Hovenier',ongedierte:'Ongediertebestrijder',apparatuur:'Reparateur',overig:'Allround klusbedrijf'};
